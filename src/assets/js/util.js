/**
 * Created by Yirius on 2017-4-30.
 * js常用工具类
 */
...
var objUtil = {
    isNull: function(myObj){
        if(typeof myObj == "undefined" || myObj == null || myObj == undefined){
            return true;
        }else{
            return false;
        }
